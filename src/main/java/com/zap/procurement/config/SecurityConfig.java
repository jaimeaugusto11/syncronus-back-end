...
public class SecurityConfig {
        ...
        public CorsConfigurationSource corsConfigurationSource() {
                ...
                configuration.setExposedHeaders(Arrays.asList("Authorization", "Content-Type", "X-Supplier-User-ID"));
                configuration.setAllowCredentials(false); // Quando se usa "*", credentials deve ser false ou
